...
@WebFilter(
		urlPatterns = { "/*" }, 
		initParams = { 
				@WebInitParam(name = "memberpage", value = "/client/member.jsp"),
				@WebInitParam(name = "tourorder", value = "/ShowSearch/search_travel_step3.jsp")
...
//							.getRequestDispatcher("/client/login.jsp");
//					rd.forward(req, resp);
					resp.sendRedirect("/Travel/client/login.jsp");
				}
			} else {
